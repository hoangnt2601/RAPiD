...
filename = "timecity1_clean"
image_dir = os.path.join(data_dir, filename)
ann_file = os.path.join(data_dir, "annotations", f"{filename}_new2.json")
ann_file_new = os.path.join(data_dir, "annotations", f"{filename}_new3.json")
